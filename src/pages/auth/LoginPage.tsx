        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative mb-6">
            ...
            <Label
              ...
              className={`absolute left-3 transition-all duration-200 pointer-events-none
                ${(isEmailFocused || email) ? 'top-0 text-xs bg-white px-1 -translate-y-1/2' : 'top-1/2 -translate-y-1/2 text-muted-foreground'}
                peer-focus:top-0 peer-focus:text-xs peer-focus:bg-white peer-focus:px-1 peer-focus:-translate-y-1/2 peer-focus:text-foreground`}
            >
              Email
            </Label>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <Label
              htmlFor="password"
              className={`absolute left-3 transition-all duration-200 pointer-events-none
                ${(isPasswordFocused || password) ? 'top-0 text-xs px-1 -translate-y-1/2 text-foreground"' : 'top-1/2 -translate-y-1/2 text-muted-foreground'}
                peer-focus:top-0 peer-focus:text-xs peer-focus:bg-white peer-focus:px-1 peer-focus:-translate-y-1/2 peer-focus:text-foreground`}
            >
              Password
            </Label>
