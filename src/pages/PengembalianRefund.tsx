    ...
    <div className="min-h-screen bg-background text-foreground pt-16 sm:pt-27">
      ...
      <div className="container mx-auto px-10 py-10 max-w-4xl">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-700">Terakhir diperbarui: 05 November 2025</p>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-3 border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>Home</span>
            <span>›</span>
            <span className="text-black">Pengembalian & Refund</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-black mb-6">Definisi</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-black mb-6">Produk Digital</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-black mb-6">Produk Fisik</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-black mb-6">Kepatuhan</h2>
          <p className="text-gray-700">
