      ...
      <div className="container mx-auto px-4 sm:px-6 pt-12 sm:pt-16">
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
          <div className="sm:text-left md:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 leading-tight tracking-wide">
          ...
          <div className="mt-6 md:mt-0">
            <img
              src="/pemesanan-undangan-cetak/undangan-cetak.webp"
              alt="Undangan Cetak"
