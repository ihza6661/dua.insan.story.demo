...
import { AddOn } from '@/features/product/services/productService';
      ...
      <div className="mt-2 space-y-1 border p-4 rounded-lg">
        {addOns.map((addOn) => (
          <div
            ...
            className="flex items-center space-x-3 p-2 rounded-md cursor-pointer transition-colors hover:bg-secondary"
          >
            <Checkbox
              id={`addon-${addOn.id}`}
