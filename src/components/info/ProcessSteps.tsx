  ...
  const processSteps = [
    {
      ...
      description: "Pastikan kamu konsultasi terlebih dahulu kepada tim Satu Momen untuk memastikan slot produksi masih tersedia. Pastikan tidak tergesa-gesa untuk hasil yang maksimal.",
    },
    {
    ...
    },
    {
      ...
      description: "Lakukan pembayaran minimal 50% dari total order untuk mengunci slot.",
    },
    {
    ...
    },
    {
      ...
      description: "Kami akan memberikan hasil desain berupa foto sehingga kamu bisa melakukan request revisi jika ada yg ingin direvisi dengan maksimal revisi 3x.",
    },
    {
    ...
    },
    {
      ...
      title: "9. Pengiriman",
      description: "Kami akan mengirimkan undangan cetakmu dari Banjarmasin ke alamat tujuan seluruh indonesia, kamu bisa request bayar di tempat atau langsung dibayar saat pesanan dikirim.",
    },
  ];
  return (
